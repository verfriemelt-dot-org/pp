<?php
    ...
    extends TestCase {
        ...
        public function numbers(): Generator {
            yield [ '1', 1 ];
            yield [ '0', 0 ];
            yield [ '-1', -1 ];
            yield [ '+1', 1 ];
         ...
         */
        public function testNumber( string $input, int | float $result ): void {
         ...
         * @dataProvider arrays
         */
        public function testArray( array $expected, string $input, string $msg ): void {
